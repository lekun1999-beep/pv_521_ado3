        ...
        Query[] queries =
{
            new Query
                ...
                "Students,Groups,Directions", "[group]=group_id AND direction=direction_id"),
            new Query
        ...
        string[] status_messages =
            {
            "Количество студентов", "Количество групп", "Количество направлений",
            "Количество дисциплин", "Количество преподавателей"
            };
        DataGridView[] tables;
        ...
        public MainForm()
        {
            ...
            { dgvStudents, dgvGroups, dgvDirections, dgvDisciplines, dgvTeachers };
    ...
    $" AND direction={d_directions[cbGroupsDirection.SelectedItem.ToString()]}");
        ...
        private void cbStudentsDirection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dgvStudents.DataSource = connector.Select
                (queries[0].ToString() + $" AND direction={d_directions[cbStudentsDirection.SelectedItem.ToString()]}");
